...
### 🔧 Разработка  
- [ ] Исправить FAQ аккордеон для мобильной версии
- [ ] Изменить порядок элементов в hero секции
- [ ] Добавить информацию о прокате на страницу цен
- [ ] Устранить надпись "тренажер"

### ✅ Тестирование
- [ ] Тестирование в Telegram WebView
...
**Все вопросы получили ответы от пользователя**:
- ✅ Информация о WebView в Telegram получена
- ✅ Стилизация информации о прокате - на усмотрение разработчика  
- ✅ `.mobile-hero-title` можно удалить, если не используется
- ✅ Критически важно не поломать десктоп и мобильную версию

**Готов перейти к выполнению** 🚀

## Lessons

- **Всегда тестировать в Telegram WebView** при разработке сайтов (разные движки на разных платформах)
- **FAQ аккордеоны требуют особого внимания** на мобильных устройствах  
