...
const scheduleBlocksRouter = require('./routes/schedule-blocks');
...
const kuligaStuckPaymentsRouter = require('./routes/kuliga-stuck-payments');
...
app.use('/api/schedule-blocks', verifyToken, scheduleBlocksRouter);
...
app.use('/api/kuliga/admin/stuck-payments', verifyToken, kuligaStuckPaymentsRouter);
